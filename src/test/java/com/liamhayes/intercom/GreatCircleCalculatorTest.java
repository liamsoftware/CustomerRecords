...
public class GreatCircleCalculatorTest {
	...
	@Test
	public void givenValidIntercomCoordinates_whenCalculateDistance_thenDistanceCalculatedCorrectlyAsZero() throws Exception {
	...
	public void givenValidIntercomCoordinates_whenCalculateDistanceForOutOfBoundsLatitude_thenExceptionThrown() throws Exception {
			GreatCircleCalculator.calculateDistanceInKm(OUT_OF_BOUNDS_LATITUDE, GreatCircleCalculator.INTERCOM_LONGITUDE);
	}
	
	@Test(expected=Exception.class)
	public void givenValidIntercomCoordinates_whenCalculateDistanceForOutOfBoundsLonogitude_thenExceptionThrown() throws Exception {
